...
class ButtonMenu(DropDown):
    def __init__(self,listaNomesBotoes, **kwargs):
...
class Menu(Button):
    def __init__(self,nomeBotao,dic_posicao,size_hint,listaNomesBotoes, **kwargs):
        super().__init__(**kwargs)
        self.size_hint = size_hint
        self.listaPaginas = ButtonMenu(listaNomesBotoes)
